...
public class KeyBoardConfigurationParser {
    private final static org.slf4j.Logger LOGGER = LoggerFactory.getLogger(KeyBoardConfigurationParser.class);
    ...
    @Autowired
    @NotNull(message = "Internal Error: Failed to get com.dronegcs.gcsis.environment")
    ...
    public void LoadParams() {
        ...
        try {
            ...
            fFilePath = Paths.get(environment.getRunningEnvConfDirectory() + File.separator + settingsFileName);
            ...
            while (scanner.hasNextLine()) {
                ...
                if (lineScanner.hasNext()) {
                    ...
                    LOGGER.info("Param: '{}', Value: '{}'", name, value);
                } else {
            ...
            if (paramAmount != 11) {
                ...
                if (paramAmount == 0) {
                    ...
                    LOGGER.error("Missing parameter: Only {} parameters were loaded\nVerify configuration file validity.", paramAmount);
