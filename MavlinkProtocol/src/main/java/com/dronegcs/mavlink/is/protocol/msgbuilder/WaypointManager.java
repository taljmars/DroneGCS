...
public class WaypointManager extends DroneVariable implements OnTimeout {
    private final static org.slf4j.Logger LOGGER = LoggerFactory.getLogger(WaypointManager.class);
    ...
    public void addWaypointManagerListener(OnWaypointManagerListener wpEventListener) {
        LOGGER.debug("{} new waypoints listener {}", getClass(), wpEventListener.getClass());
