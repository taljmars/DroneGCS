...
public class Parameters extends DroneVariable implements OnDroneListener {
    private final static org.slf4j.Logger LOGGER = LoggerFactory.getLogger(Parameters.class);
    ...
    @Autowired
    @NotNull(message = "Internal Error: Failed to get handler")
    ...
    public void addParameterListener(DroneInterfaces.OnParameterManagerListener parameterListener) {
        LOGGER.debug("{} Setting new paramter listener {}", getClass().getName(), parameterListener.getClass());
