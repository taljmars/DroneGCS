...
public class DroneEye extends StackPane implements ObjectDetectorListener, OnDroneListener, Initializable {
    ...
    @NotNull
    @FXML
    private Label lblDistToLaunch;
    @NotNull
    @FXML
    private Label lblBattery;
    @NotNull
    @FXML
    private Label lblPointerToHome;
    @NotNull
    @FXML
    private Label lblPointerToHomeBorder;
    @NotNull
    @FXML
    private Label lblCompass;
    @NotNull
    @FXML
    private Label lblCompassBorder;
    @NotNull
    @FXML
    private Label lblFlightTime;
    @NotNull
    @FXML
    private Label lblFlightDist;
