...
public class CheckBoxTree extends JTree {
    ...
    public void remove(DefaultMutableTreeNode parent, final AbstractLayer layer) {
        layer.setVisible(data(parent).isSelected());
        DefaultMutableTreeNode node = searchNode(layer);
    ...
    //TALMA
    public DefaultMutableTreeNode removeLayer(AbstractLayer layer) {
        if (layer == null)
        	return null;
        ...
        DefaultMutableTreeNode parent = searchNode(layer.getParent());
        if (parent == null)
        	parent = removeLayer(layer.getParent());        	
        else
        	remove(parent, layer);
    ...
    public void Save() {
    	...
    	CheckBoxNodeData data = CheckBoxTree.data(root);
    	AbstractLayer layer = data.getAbstractLayer();
    	if (layer instanceof Layer) {
    		Layer lr = (Layer) data.getAbstractLayer();
    		lr.getElements();
    	}
