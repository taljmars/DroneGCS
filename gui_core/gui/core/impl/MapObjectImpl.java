...
public abstract class MapObjectImpl implements Serializable /*TALMA add serilizebae*/ {
    /**
	 * 
	 */
	private static final long serialVersionUID = 3803945535373940983L;
	private Layer layer;
    private String name;
    private Style style;
    ...
    public MapObjectImpl(Layer layer, String name, Style style) {
        ...
        this.style = style;
        if (this.layer != null)
        	this.layer.add((MapObject) this);
    }
    
    public MapObjectImpl(Layer layer, MapObjectImpl mo) {
    	this(layer, mo.getName(), mo.getStyle());
    }
