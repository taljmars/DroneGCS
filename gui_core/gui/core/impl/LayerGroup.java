...
public class LayerGroup extends AbstractLayer implements Serializable /*TALMA add serilizebae*/ {
    /**
	 * 
	 */
	private static final long serialVersionUID = 5016090855857532794L;
    ...
    public LayerGroup remove(AbstractLayer layer) {
        layers.remove(layer);
        return this;
    }
