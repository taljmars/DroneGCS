...
import mavlink.is.utils.units.Area;
...
public class GeoTools {
	...
	public static double getHeadingFromCoordinates(Coordinate fromLoc, Coordinate toLoc) {
		Coord2D a = new Coord2D(fromLoc.getLat(), fromLoc.getLon());
		Coord2D b = new Coord2D(toLoc.getLat(), toLoc.getLon());
		
		return getHeadingFromCoordinates(a, b);
	}
