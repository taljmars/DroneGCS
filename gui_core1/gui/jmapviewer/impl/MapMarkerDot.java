 ...
 *
 */
public class MapMarkerDot extends MapMarkerCircle implements Serializable /*TALMA add serilizebae*/ {

    /**
	 * 
	 */
	private static final long serialVersionUID = 118083602729699370L;
    ...
    public MapMarkerDot(Layer layer, String name, Color color, double lat, double lon) {
        this(layer, name, lat, lon);
        setColor(color);
    }
    ...
    public MapMarkerDot(Layer layer, MapMarkerDot mo) {
		super(layer, mo);
	}
