...
public class JMapViewerTree extends JPanel {
            ...
            public void actionPerformed(ActionEvent arg0) {
            	if (layer instanceof LayerMission) {
            		...
            		if (ActiveLayerMission.getMission() != null) {
            			Dashboard.addOutgoingMessegeToDisplay("Sending Mission To APM");
            			ActiveLayerMission.getMission().sendMissionToAPM();
            			ActiveLayerMission.setName("(ACTIVE) " + ActiveLayerMission.getName());
            			Dashboard.addOutgoingMessegeToDisplay("Change mode to " + ApmModes.ROTOR_AUTO.getName());
            			Dashboard.drone.getState().changeFlightMode(ApmModes.ROTOR_AUTO);
            			Dashboard.MessegeQueue_Add("Start Mission");
            			Dashboard.MessegeQueue_Add("Start Mission");
            			Dashboard.MessegeQueue_Add("Start Mission");
            		}
        ...
        menuItemDeactivateMission.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
            	if (layer instanceof LayerMission) {
            		...
            		Dashboard.addGeneralMessegeToDisplay("Comming back to lunch position");
            		Dashboard.MessegeQueue_Add("Return To Lunch");
            ...
            public void actionPerformed(ActionEvent arg0) {
            	if (layer instanceof LayerPerimeter) {
            		if (ActiveLayerPerimeter != null && ActiveLayerPerimeter != layer) {
            			Dashboard.addGeneralMessegeToDisplay("Stopping current perimeter");
        			...
        			if (l.getElements().size() != 1 || !(l.getElements().get(0) instanceof MapPolygonImpl)) {
        				Dashboard.addErrorMessegeToDisplay("Missing Perimeter in Layer");
        				ActiveLayerPerimeter = null;
        			}
        			
        			Dashboard.addGeneralMessegeToDisplay("Enable Perimeter Alert");
        ...
        menuItemDeactivatePerimeterAlarm.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
            	if (layer instanceof LayerPerimeter) {
        			...
        			Dashboard.addGeneralMessegeToDisplay("Disable Perimeter Alert");
        ...
        menuItemActivatePerimeterEnforce.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
            	if (layer instanceof LayerPerimeter) {
        			...
        			Dashboard.addGeneralMessegeToDisplay("Enable Perimeter Enforce");
        ...
        menuItemDeactivatePerimeterEnforce.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
            	if (layer instanceof LayerPerimeter) {
            		...
            		Dashboard.addGeneralMessegeToDisplay("Disable Perimeter Enforce");
    ...
    public void SaveLayersTree() {
    	Dashboard.addGeneralMessegeToDisplay("Saving Map Views");
		...
		try {
			...
			e.printStackTrace();
			Dashboard.addErrorMessegeToDisplay("Failed to save map view to " + fFilePath.toString());
		}
    }
    
    public void LoadLayersTree() {
    	Dashboard.addGeneralMessegeToDisplay("Loading Map Views");
    	String settingsFilePath = "LayersData.ini";
    	Path fFilePath = Paths.get(settingsFilePath);
		/*if (fFilePath.toFile().exists() == false) {
			JFileChooser fileChooser = new JFileChooser();
		...
		try {
			...
			file.close();
			fOut.close();
			Dashboard.addGeneralMessegeToDisplay("Map View were successfully loaded to " + fFilePath.toString());
			tree.removeAll();
			setTree(tmp);
			Dashboard.addGeneralMessegeToDisplay("Reresh tree");
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			Dashboard.addErrorMessegeToDisplay("Failed to load map view to " + fFilePath.toString());
		}
    }
