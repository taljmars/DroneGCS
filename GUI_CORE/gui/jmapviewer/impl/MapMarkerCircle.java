 ...
 *
 */
public class MapMarkerCircle extends MapObjectImpl implements MapMarker, Serializable /*TALMA add serilizebae*/ {

    /**
	 * 
	 */
	private static final long serialVersionUID = 663353207508444226L;
    ...
    public MapMarkerCircle(String name, Coordinate coord, double radius, Style style) {
        this(null, null, coord, radius, STYLE.VARIABLE, style);
    }
    ...
    public MapMarkerCircle(Layer layer, MapMarkerCircle mo) {
    	super(layer, mo);
    	this.markerStyle = mo.markerStyle;
